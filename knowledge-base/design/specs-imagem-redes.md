...
## Tabela multi-plataforma (referência — frente futura multi-canal)
<!-- Destilado das Adobe Creative Skills (adobe-create-social-variations, 2026-06-24). Hoje só fazemos
     Instagram; isto é referência p/ quando a plataforma virar (plataforma-agnostica-ponta-aberta). -->
A largura útil é quase sempre **1080 px** (mesma lógica da Meta); as proporções é que mudam por canal:

| Plataforma | Formato | Dimensão | Proporção |
|---|---|---|---|
| Instagram / Threads | Feed retrato | 1080 × 1350 | 4:5 |
| Instagram / LinkedIn / Facebook / X | Feed quadrado | 1080 × 1080 | 1:1 |
| Instagram / TikTok / Facebook | Story / Reel | 1080 × 1920 | 9:16 |
| LinkedIn | Post paisagem | 1200 × 627 | ~2:1 |
| Facebook | Feed paisagem | 1200 × 630 | ~2:1 |
| X/Twitter | In-stream | 1200 × 675 | 16:9 |
| YouTube | Thumbnail | 1280 × 720 | 16:9 |
| Pinterest | Pin padrão | 1000 × 1500 | 2:3 |
| Snapchat | Snap/Story | 1080 × 1920 | 9:16 (limite 250 KB → comprimir forte) |
| Print | A4 / US Letter | 2480 × 3508 / 2550 × 3300 | 300 DPI (só print) |

**Disciplina nossa (≠ esticar a peça pronta):** ao levar para outro formato, **re-renderizar a peça no
molde naquela proporção** — a composição é re-diagramada, não recortada/distorcida. Reframe automático
(corte ciente de rosto/sujeito) e expansão de canvas valem para ADAPTAR FOTO/ASSET de fundo, não a peça
final. Ver [tratamento-de-foto-e-looks.md](tratamento-de-foto-e-looks.md) §4 (enquadramento) e o filtro da
regra de ouro em `knowledge-base/sistema/agent-skills-e-externas.md`.

**Vídeo só na mesma proporção:** redimensionar vídeo cross-ratio (16:9 → 9:16) gera barras pretas e é
**penalizado por TikTok/Reels**. Mudar de proporção em vídeo pede reedição/reframe real, não resize.
